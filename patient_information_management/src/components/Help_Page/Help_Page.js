...
export default function Help_Page() {
  ...
  return(
    <section>
        ...
        <section>
            <Accordion defaultActiveKey="#"> {/*This line sets the default value of the accordions to closed, so that the user can choose which ones to open.*/}
        ...
        <h3>More information</h3>
                <br/><p>For more information on this project, see the About Us page.</p><p/><br/>
